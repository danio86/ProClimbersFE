...
export const ORDER_LIST_MY_ADMIN_REQUEST = 'ORDER_LIST_MY_ADMIN_REQUEST'
export const ORDER_LIST_MY_ADMIN_SUCCESS = 'ORDER_LIST_MY_ADMIN_SUCCESS'
export const ORDER_LIST_MY_ADMIN_FAIL = 'ORDER_LIST_MY_ADMIN_FAIL'
